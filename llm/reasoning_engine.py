...
from llm.intent_classifier import classify_intent_hybrid
...
def generate_intent(text: str) -> dict:
    ...
    # ------------------------------
    # 7. SEMANTIC INTENT (HYBRID)
    # ------------------------------
    intent = classify_intent_hybrid(text)
    if intent:
        return intent
